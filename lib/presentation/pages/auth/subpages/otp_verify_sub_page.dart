...
@RoutePage()
class OtpVerifySubPage extends StatelessWidget {
  const OtpVerifySubPage({super.key});

  @override
  Widget build(BuildContext context) {
    final cubit = context.read<OtpLoginCubit>();
    return BlocListener<OtpLoginCubit, OtpLoginState>(
      ...
      child: AppScaffold(
        ...
        body: AppListBody(
          children: [
            ...
            AppButton(
              onTap: () => context.read<OtpLoginCubit>().verifyOtp(),
...
class _InfoText extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Text(
    'A 6-digit code was sent to your Innopolis email. It expires in 10 minutes.',
